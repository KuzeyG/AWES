...
class DiscordMusicBot extends Client {
    ...
    this.Manager = new Manager({
      ...
      .on("trackStart", async (player, track) => {
        ...
        let TrackStartedEmbed = new MessageEmbed()
          .setAuthor(`Şuanda Çalıyor ♪`, this.botconfig.IconURL)
          ...
          .setFooter(this.botconfig.TextFooter,this.botconfig.IconFooter);
      ...
      .on("queueEnd", (player) => {
        let QueueEmbed = new MessageEmbed()
          .setAuthor("Kuyruk sona erdi", this.botconfig.IconURL)
          .setColor(this.botconfig.EmbedColor)
          .setTimestamp();
  ...
  sendError(Channel, Error) {
    let embed = new MessageEmbed()
      ...
      .setFooter(
        "Bunun bir hata olduğunu düşünüyorsanız, lütfen destek sunucusuna bildirin!"
      );
