module.exports = {
   Admins: ["445334682091913217", "521266104773902346"], //Admins of the bot
  ExpressServer: true, //If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || "!", //Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/BUbnkSSq", //Support Server Link
  ...
  Website: process.env.Website || "", //Website where it is hosted at includes http or https || Use "0.0.0.0" if you using Heroku || Do not include /api/callback. Just the website url. I.e. "https://foo.bar"
   IconFooter:
    "https://www.freelogovectors.net/wp-content/uploads/2020/08/dogu-akdeniz-universitesi-logo.png", //Antidau
    TextFooter:
    "Created By AntiDaü Students • 21.10.2021", //Antidau
  Presence: {
    status: "online", // You can show online, idle, and dnd
    name: "7/24 Müzik", // The message shown
